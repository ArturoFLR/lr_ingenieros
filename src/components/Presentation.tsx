...
function Presentation() {
	...
	const iconsContainerObserver = new IntersectionObserver(
		(entries) => {
		...
		<div className={styles.mainContainer}>
			<div className={styles.textContainer}>
				<h1 className={styles.mainParagraph}>
					<span className={styles.brand}>L&R Ingenieros</span> te ofrece las soluciones a tus Proyectos de Instalaciones
					en Edificiación.
				</h1>
				<p className={styles.mainParagraph}>
					Desde la fase de <span>Anteproyecto</span> hasta la Asistencia Técnica en obra, te acompañamos en el diseño de
					tu Edificio hasta alcanzar los objetivos de <span>calidad y eficiencia</span> deseados.
				</p>
				<p>
					Tanto en edificación singular como en edificios residenciales, la <span>amplia experiencia</span> y formación
					de nuestros técnicos garantizarán la optimización de cada Proyecto, en cuanto a eficiencia energética,
					facilidad de mantenimiento, control y regulación de la energía, cumplimiento de normativa y{" "}
					<span>costes de implantación competitivos.</span>
				</p>
			</div>
			...
			<div className={styles.opinionsContainer}>
				<div className={styles.pictureOpinionContainer}>
					...
					<p className={styles.opinion}>
						Lo mejor de L&R es el trato cercano y la facilidad de hacer equipo para disfrutar el proceso de hacer un
						buen proyecto.
					</p>
				</div>
				...
				<div className={`${styles.pictureOpinionContainer} ${styles.pictureOpinionContainer2}`}>
					...
					<p className={styles.opinion}>
						Más de 200 informes de consultoría técnica realizados con ellos y con ganas de seguir colaborando en muchos
						más.
					</p>
				</div>
				...
				<div className={`${styles.pictureOpinionContainer} ${styles.pictureOpinionContainer3}`}>
					...
					<p className={styles.opinion}>
						Llevamos más de 15 años trabajando juntos en todo tipo de proyectos y direcciones de obra, somos como un
						gran equipo.
					</p>
				</div>
			</div>
